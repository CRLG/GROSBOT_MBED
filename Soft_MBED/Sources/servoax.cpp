...
tAxErr ServoAX::read(unsigned char *buff_data, unsigned char size)
{
...
// ______________________________________________________________
tAxErr ServoAX::write(unsigned char *buff_data, unsigned char size)
{
...
// ______________________________________________________________
tAxErr ServoAX::flushSerialInput()
{
...
// ______________________________________________________________
tAxErr ServoAX::waitTransmitComplete()
{
...
// ______________________________________________________________
tAxErr ServoAX::setTxEnable(bool state)
{
    _Stor3 = state;
    return AX_OK;
}
...
// ______________________________________________________________
void ServoAX::delay_us(unsigned long delay)
{
    wait_us(delay);
}
...
bool ServoAX::isPresent(unsigned char id)
{
    return ServoAXBase::isPresent(id);
}

// ____________________________________________________________
tAxErr ServoAX::setPosition(unsigned char id, unsigned short position)
{
    return ServoAXBase::setPosition(id, position);
}

// ____________________________________________________________
tAxErr ServoAX::setSpeed(unsigned char id, unsigned short speed)
{
   return ServoAXBase::setSpeed(id, speed);
}

// ____________________________________________________________
tAxErr ServoAX::setPositionSpeed(unsigned char id, unsigned short position, unsigned short speed)
{
    return ServoAXBase::setPositionSpeed(id, position, speed);
}

// ____________________________________________________________
unsigned short ServoAX::getPosition(unsigned char id, tAxErr *err_status)
{
    return ServoAXBase::getPosition(id, err_status);
}

// ____________________________________________________________
bool ServoAX::isMoving(unsigned char id, tAxErr *err_status)
{
    return ServoAXBase::isMoving(id, err_status);
}

// ____________________________________________________________
tAxErr ServoAX::changeID(unsigned char old_id, unsigned char new_id)
{
    return ServoAXBase::changeID(old_id, new_id);
}

// ____________________________________________________________
tAxErr ServoAX::enableTorque(unsigned char id, bool on_off)
{
    return ServoAXBase::enableTorque(id, on_off);
}

// ____________________________________________________________
tAxErr ServoAX::setMode(unsigned char id, unsigned char mode)
{
    return ServoAXBase::setMode(id, mode);
}

// ____________________________________________________________
tAxErr ServoAX::setLimitPositionMin(unsigned char id, unsigned short pos)
{
    return ServoAXBase::setLimitPositionMin(id, pos);
}

// ____________________________________________________________
tAxErr ServoAX::setLimitPositionMax(unsigned char id, unsigned short pos)
{
...
// ______________________________________________________________
tAxErr ServoAX::readEEPROM(void)
{
    tAxErr err;
