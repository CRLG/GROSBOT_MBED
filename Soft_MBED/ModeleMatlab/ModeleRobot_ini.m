...
SERVO_CENTREUR_G_CENTRE_SPOT=62;
SERVO_CENTREUR_G_FERME=27;

%SERVO CENTREUR D
SERVO_CENTREUR_D_OUVERT = 21;
SERVO_CENTREUR_D_CENTRE_SPOT=86;
SERVO_CENTREUR_D_FERME=130;

%SERVO PINCE D
SERVO_PINCE_D_OUVERT = 1;
SERVO_PINCE_D_ENTRE_OUVERT = 41;
SERVO_PINCE_D_LACHE_BALLE=110;
SERVO_PINCE_D_PRISE_GOBELET=95;
SERVO_PINCE_D_FERME=120;

%SERVO PINCE G
SERVO_PINCE_G_OUVERT = 205;
SERVO_PINCE_G_ENTRE_OUVERT = 155;
SERVO_PINCE_G_LACHE_BALLE=104;
SERVO_PINCE_G_PRISE_GOBELET=101;
